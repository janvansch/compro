...
-- S14-2
INSERT INTO adt_trx_proc_state(file_id, trx_id, proc_id, seq_id, proc_type, trx_proc_state, user_id, message)
  SELECT file_id, trx_id, procId, 0, 'L', 'E', 'admin01', '{S14:Invalid line of business}'  
  ...
  ON DUPLICATE KEY UPDATE adt_trx_proc_state.message=concat(message, ',', '{S14:Invalid line of business*}')			
;
