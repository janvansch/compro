INSERT INTO adt_trx_proc_state(file_id, trx_id, proc_id, seq_id, proc_type, trx_proc_state, user_id, message)
  SELECT currtrx.file_id, currtrx.trx_id, 2016082623590000, 0, 'L', 'W', 'admin01', '{S17:Warning - marketers code 2 history mismatch}'  
  ...
  WHERE currtrx.file_id = 2 
	AND history.marketers_code_2 IS NULL
    AND currtrx.period IS NOT NULL
